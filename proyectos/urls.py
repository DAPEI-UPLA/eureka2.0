...
urlpatterns = [
    ...
    path('proyectos/<int:pk>/gantt/', views.gantt_proyecto, name="gantt_proyecto"),
    path('proyectos/<int:pk>/valor-ganado/', views.valor_ganado, name="valor_ganado"),
    ...
    path('proyectos/<int:pk>/anios/crear-todos/', views.crear_anios_del_proyecto, name="crear_anios_del_proyecto"),
    path('proyectos/<int:pk>/anios/realinear/', views.realinear_anios, name="realinear_anios"),
    ...
    path('resultado/<int:pk>/avance/', views.avance_resultado_form, name='avance_resultado_form'),
    path('resultado/<int:pk>/avance/guardar/', views.guardar_avance_resultado, name='guardar_avance_resultado'),
